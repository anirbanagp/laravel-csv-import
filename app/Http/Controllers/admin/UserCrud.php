...
class UserCrud extends Crud
{
	...
	public function add(Request $request)
	{
		...
		if($this->user->role_id == '1') {
			...
			$data['input_list']['parent_id']['field_type'] 	= 'hidden';
			$data['input_list']['parent_id']['default_value'] 	= User::whereRoleId('2')->first()->id;
			$data['input_list']['role_id']['field_type'] 	= 'hidden';
			$data['input_list']['role_id']['default_value'] = '2';
		}
	...
	public function viewChildrenLink($row_data,$value,$type)
	{
		...
		if($type =="list" && count($this->role_based_children[$row_data->role_id]) && $this->user->role_id == 1){
