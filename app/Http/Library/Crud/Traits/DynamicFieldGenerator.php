...
trait DynamicFieldGenerator
{
	 ...
	 */
	public function setRelation($coloumn_name,$table_name,$show_field,$key='id', $where = null, $constraint = null)
	{
		$each_relation = [];
		...
		$each_relation['show_constraint'] 	= $constraint ?? $table_name.'_'.$show_field;
