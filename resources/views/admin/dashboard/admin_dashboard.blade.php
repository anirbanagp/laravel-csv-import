        ...
        <div class="row clearfix dbCount">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-blue hover-expand-effect custom">
                    <div class="icon">
                        <img src="{{asset('new_admin/images/patient.svg')}}" class="img-responsive" />
                    </div>
                    <div class="content">
                        <div class="text">Patients</div>
                        <div class="number count-to" data-from="0" data-to="{{ $patient }}" data-speed="1000" data-fresh-interval="20">{{ $patient }}</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-dark-yellow hover-expand-effect custom">
                    <div class="icon">
                        <img src="{{asset('new_admin/images/identification-card.svg')}}" class="img-responsive">
                    </div>
                    <div class="content">
                        <div class="text">Associates</div>
                        <div id="onlineUsers" class="number count-to" >{{ $collector }}</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-violet hover-expand-effect custom">
                    <div class="icon">
                        <img src="{{asset('new_admin/images/blood-sample-bnw.svg')}}" class="img-responsive" />
                    </div>
                    <div class="content">
                        <div class="text">Tests</div>
                        <div class="number count-to" data-from="0" data-to="2300" data-speed="1000" data-fresh-interval="20">{{ $test }}</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-green hover-expand-effect custom">
                    ...
                    <div class="content">
                        ...
                        <div class="number count-to" data-from="0" data-to="2300" data-speed="1000" data-fresh-interval="20">{{ $amount }}</div>
                    </div>
                </div>
            </div>
        </div>
